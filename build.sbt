...
val root = Project("podcasts-rss", file("."))
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.gu" %% "content-api-client" % "35.0.0-PREVIEW.bump-capi-model-to-support-new-podcast-metadata-fields.2025-06-17T0956.13a18524",
      ...
      "com.gu" %% "content-api-models-json" % "28.0.0-PREVIEW.add-episodic-artwork-fields.2025-06-17T0819.478ca91c" % "test", // keeping in line with imports from content-api-client
