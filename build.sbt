...
val root = Project("podcasts-rss", file("."))
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.gu" %% "content-api-client" % "36.0.0-PREVIEW.bump-capi-models-to-bring-in-new-podcast-fields.2025-08-07T1529.c9020e16",
      ...
      "com.gu" %% "content-api-models-json" % "30.0.0-PREVIEW.add-new-podcast-fields.2025-08-07T1437.73d8c924" % "test", // keeping in line with imports from content-api-client
